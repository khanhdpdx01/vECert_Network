...
//        System.out.println(diploma);
    ...
    public String searchBySerialNumber(final Context ctx, final String serialNumber) {
        ...
        DiplomaResponse response = new DiplomaResponse(genson.deserialize(diplomaJson, Diploma.class), stub.getTxId());
        System.out.println(response);
        return genson.serialize(response);
//        return genson.deserialize(diplomaJson, Diploma.class);
    }
    ...
    public String getString(Context ctx) {
        return "I got my head in sunroof";
    }

    public boolean checkFeilds(String... args) {
        for (String feild : args) {
            if (feild == null) {
                return false;
            }
        }
